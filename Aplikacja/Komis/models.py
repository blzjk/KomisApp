...
class Samochod(models.Model):
    ...
    przebieg = models.CharField(max_length=20, null=True, blank=True)
    ...
    numer_rejestracyjny = models.CharField(max_length=20, null=True, blank=True)
    numer_seryjny = models.CharField(max_length=20, null=True, blank=True)
    ...
    uzytkownik = models.ForeignKey(User, default=User, on_delete=models.CASCADE, null=True, blank=True, related_name='uzytkownik')
